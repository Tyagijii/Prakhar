...
`;
  ...
  var po = o((s = {}) => {
    ...
    function Dt(e) {
      var _a2, _b2, _c2;
      if (!e)
        return Dt((_a2 = s.font) != null ? _a2 : Ai);
      if (typeof e == "string") {
        let n = Pt(e), r = Ot(e);
        if (n)
    ...
    function zn(e) {
      ...
      if (e.radiusX === 0 || e.radiusY === 0)
        return;
      let n = (_a2 = e.start) != null ? _a2 : 0, r = (_b2 = e.end) != null ? _b2 : 360, i = ut((_c2 = e.anchor) != null ? _c2 : "center").scale(new v(-e.radiusX, -e.radiusY)), u = mt(i, e.radiusX, e.radiusY, n, r, e.resolution);
      u.unshift(i);
...
`)
    ...
    function js(e, n = {}) {
      ...
      return { id: "lifespan", add() {
        return __async(this, null, function* () {
          yield gt(e), r > 0 && this.opacity && (yield Tn(this.opacity, 0, r, (i) => this.opacity = i, ot.linear)), this.destroy();
        });
      } };
    }
    __name(js, "js");
    ...
    function Ks(e, n) {
      ...
      let r = bt([Nt((_a2 = n.pos) != null ? _a2 : S(0))]), i = e.length, u = 0, l = null, a = null, m = null, f = null, p = o((y) => y.x + y.y * u, "tile2Hash"), x = o((y) => S(Math.floor(y % u), Math.floor(y / u)), "hash2Tile"), D = o(() => {
        l = [];
